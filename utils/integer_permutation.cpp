 ...
 *****************************************************************************
 ...
 Implementation of interfaces for a permutation of the integers in
...
integer_permutation::integer_permutation(const size_t min_element,
...
integer_permutation integer_permutation::inverse() const {
  ...
  for (size_t position = min_element; position <= max_element; ++position) {
    result.contents[this->contents[position - min_element] - min_element] =
        position;
  }
...
integer_permutation integer_permutation::slice(
    const size_t slice_min_element, const size_t slice_max_element) const {
  assert(min_element <= slice_min_element &&
